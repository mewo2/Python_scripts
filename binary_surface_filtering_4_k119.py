...
file_name = r"/geog/data/altair/epsilon/ggwillc/AL_ARSF_GRNLND_2013/LiDAR/203a/post_0.5/bin/201a.wholeGlacier.0.5.bin" # the r escapes numbers (and special characters like capital letters) in the pathname
...
image_output_original =  r'/home/staff/ggwillc/Desktop/filtering_output_images/'+ '203a_original.png'
...
if os.path.isdir(opath):
	...
	os.makedirs(r"/geog/data/altair/epsilon/ggwillc/AL_ARSF_GRNLND_2013/LiDAR/203a/post_0.5/bin/") 
