...
file_name = r"/geog/data/sirius/epsilon/ggwillc/Helheim/helheim_lidar_sorting/223-_lidar/bin/223-.helheim_post_0.5m.bin.snip"
...
print '~~~~~~~~~~~~~~'
print 'Maximum' #(see: http://docs.scipy.org/doc/scipy/reference/generated/scipy.ndimage.filters.maximum_filter.html)
print '~~~~~~~~~~~~~~'

method = "_maximum"
dem_maximum_filter = ndimage.filters.maximum_filter()		#signal.medfilt2d(image_array,kernel_size=kernel)
print dem_maximum_filter.shape

filtered_image = dem_maximum_filter
filtered_image_name = "HELHEIM_222a_dem_maximum_filter_kernel_%i" % kernel
...
opath = r"/geog/data/sirius/epsilon/ggwillc/Helheim/helheim_lidar_sorting/223-_lidar/bin/"

if os.path.isdir(opath):
	print "output_path exists"	
else:
	print "output_path DOESN'T exist...\n"
	os.makedirs(r"/geog/data/sirius/epsilon/ggwillc/Helheim/helheim_lidar_sorting/223-_lidar/bin/")
...
ax1.set_title('Unfiltered surface: Helheim 223')
...
ax2.set_title('Filtered surface: Helheim 223')
...
ax3.set_title('Difference surface: Helheim 223')
