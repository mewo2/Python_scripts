...
crevasse_array = image_array - filtered_image
crevasse_array_20_temp = (crevasse_array/100)*20
crevasse_array_20_surface = crevasse_array - crevasse_array_20_temp

print crevasse_array_20_surface.shape
print crevasse_array_20_surface.size
filtered_image_name = "HELHEIM_222a_dem%s_filter_kernel_%i_20_percent_reduction" %(method, kernel)
...
opath = r"/geog/data/sirius/epsilon/ggwillc/Maximum_surface_filtering/Helheim/222/"

if os.path.isdir(opath):
	print "output_path exists"	
else:
	print "output_path DOESN'T exist...\n"
	os.makedirs(r"/geog/data/sirius/epsilon/ggwillc/Maximum_surface_filtering/Helheim/222/") 
...
ax3.plot(x[:,x.shape[0]/2],crevasse_array_20_surface[:,x.shape[0]/2],'g') # creates a plot with the x axis taken halfway along the x array - the y axis values are from the image-array at the x positions
ax3.set_title('Difference surface (20% reduction)')
