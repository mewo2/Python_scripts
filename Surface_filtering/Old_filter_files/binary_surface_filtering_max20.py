...
#filtered_image_name = "203a_dem_max_filter_kernel_%i" % kernel
...
#filtered_image_name = "203a_dem_max_10_filter_kernel_%i" % kernel
...
filtered_image_name = "203a_dem_max_20_filter_kernel_%i" % kernel
