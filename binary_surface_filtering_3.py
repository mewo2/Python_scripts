...
dem_025_refactor = ndimage.zoom(image_aray, 0.25, order=0) ## essentially refactors the array by a factor the order value denotes the interpolation algorithm used
...
image_ouput_original =  r'/home/staff/ggwillc/Desktop/filtering_output_images/'+ '201a_original.png'
...
#plt.colorbar(display)
#image_ouput =  r'/home/staff/ggwillc/Desktop/filtering_output_images/'+ filtered_image_name
...
#plt.show()
image_ouput = r'/home/staff/ggwillc/Desktop/filtering_output_images/' + filtered_image_name + 'slices.png'
plt.savefig(image_output)

# crevasse array slice
